...
```csharp
using Shiny.Maui.Diagrams.Controls;    // MermaidDiagramControl
using Shiny.Maui.Diagrams.Extensions;  // UseShinyDiagrams
using Shiny.Maui.Diagrams.Models;      // DiagramModel, DiagramNode, DiagramEdge, etc.
using Shiny.Maui.Diagrams.Parsing;     // MermaidParser, MermaidLexer
using Shiny.Maui.Diagrams.Layout;      // ILayoutEngine, SugiyamaLayoutEngine, DiagramLayoutOptions
using Shiny.Maui.Diagrams.Rendering;   // DiagramDrawable, NodeRenderer, EdgeRenderer
using Shiny.Maui.Diagrams.Theming;     // DiagramTheme, DefaultTheme, DarkTheme, etc.
```
...
```csharp
namespace Shiny.Maui.Diagrams.Extensions;
